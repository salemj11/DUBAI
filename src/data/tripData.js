...
const PLACE_CATALOG = [
  ...
  definePlace({
    ...
    subcategory: 'design-cafe',
    area: 'Al Quoz',
    description: 'A real Al Quoz original where specialty coffee, custom bikes, and warehouse energy all hit the same cool-group frequency.',
    tags: ['coffee', 'design', 'alserkal'],
    vibeTags: ['industrial', 'cult-favorite', 'warehouse-cool'],
    priceLevel: 2,
    sourceConfidence: 'confirmed',
    rating: 4.6,
    googleQuery: 'Cafe Rider Dubai',
    featured: true,
  }),
  definePlace({
    id: 'lazy-cat',
    ...
    category: 'chill',
    subcategory: 'design-cafe',
    area: 'Al Quoz Pond Park',
    description: 'A current park-side cafe with a soft cool-kid crowd, strong pastries, and enough personality to avoid feeling generic.',
    tags: ['coffee', 'design', 'alserkal'],
    vibeTags: ['park-side', 'airy', 'trending'],
    priceLevel: 2,
    sourceConfidence: 'confirmed',
    rating: 4.6,
    googleQuery: 'Lazy Cat Dubai Al Quoz Pond Park',
    featured: true,
  }),
  definePlace({
  ...
  definePlace({
    ...
    subcategory: 'design-cafe',
    area: 'Jumeirah 3',
    description: 'A proper Jumeirah villa-cafe pick with garden energy and a crowd that feels polished without getting stiff.',
    tags: ['coffee', 'design', 'jumeirah'],
    vibeTags: ['villa-cafe', 'garden', 'locals-favorite'],
    priceLevel: 2,
    sourceConfidence: 'confirmed',
    rating: 4.6,
    googleQuery: 'Villa 515 Dubai',
    featured: true,
  }),
  definePlace({
    ...
    subcategory: 'design-cafe',
    area: 'Jumeirah',
    description: 'A quirky Jumeirah coffee stop with enough personality and cult following to feel curated instead of safe.',
    tags: ['coffee', 'design', 'jumeirah'],
    vibeTags: ['space-theme', 'quirky', 'local-favorite'],
    priceLevel: 2,
    sourceConfidence: 'confirmed',
    rating: 4.5,
    googleQuery: 'To The Moon and Back Coffee Dubai',
  }),
  definePlace({
    id: 'arabica-dubai-mall',
    slug: 'arabica-dubai-mall',
    name: '% Arabica Dubai Mall',
    emoji: '☕',
    category: 'chill',
    subcategory: 'design-cafe',
    area: 'Dubai Mall',
    description: 'The sharpest coffee-first Dubai Mall stop if you want a real cafe break without drifting into generic mall filler.',
    tags: ['coffee', 'design'],
    vibeTags: ['minimal', 'high-traffic', 'coffee-first'],
    priceLevel: 2,
    sourceConfidence: 'confirmed',
    rating: 4.6,
    googleQuery: '% Arabica Dubai Mall',
    featured: true,
  }),
  definePlace({
    id: 'hoof-cafe-dubai-mall',
    slug: 'hoof-cafe-dubai-mall',
    name: 'HOOF Cafe Dubai Mall',
    emoji: '🐎',
    category: 'chill',
    subcategory: 'design-cafe',
    area: 'Dubai Mall Fashion Avenue',
    description: 'An Emirati-grown coffee stop inside Dubai Mall that still feels tasteful and current enough to make the deck.',
    tags: ['coffee', 'design'],
    vibeTags: ['emirati-owned', 'fashion-avenue', 'current'],
    priceLevel: 2,
    sourceConfidence: 'confirmed',
    rating: 4.5,
    googleQuery: 'HOOF Cafe Dubai Mall',
  }),
  definePlace({
    id: 'home-bakery-dubai-mall',
    slug: 'home-bakery-dubai-mall',
    name: 'Home Bakery Dubai Mall',
    emoji: '🧁',
    category: 'chill',
    subcategory: 'design-cafe',
    area: 'Dubai Mall Fashion Avenue',
    description: 'A popular local staple for coffee and sweets that fits better than generic mall chains when the group wants a softer reset.',
    tags: ['coffee', 'design'],
    vibeTags: ['locals-favorite', 'dessert-run', 'fashion-avenue'],
    priceLevel: 2,
    sourceConfidence: 'confirmed',
    rating: 4.5,
    googleQuery: 'Home Bakery Dubai Mall',
  }),
  definePlace({
    id: 'five-palm-pool',
    slug: 'five-palm-pool',
