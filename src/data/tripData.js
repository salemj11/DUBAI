...
const PLACE_CATALOG = [
  ...
  definePlace({
    ...
    description: 'A Palm West Beach staple with social energy, music, and easy group momentum without drifting into stiff dinner territory.',
    tags: ['palm', 'late-night', 'casual'],
    vibeTags: ['Palm West Beach', 'social', 'sunset-to-late'],
    priceLevel: 3,
    sourceConfidence: 'curated',
    rating: 4.4,
    googleQuery: 'February 30 Dubai Palm West Beach',
  }),
  definePlace({
    id: 'surf-club-dubai',
    slug: 'surf-club-dubai',
    name: 'Surf Club Dubai',
    emoji: '🌊',
    category: 'food',
    subcategory: 'smart-casual',
    area: 'Palm West Beach',
    description: 'Palm West Beach food-and-scene energy that feels much more on-brand than adding another random beach club.',
    tags: ['palm', 'design-forward', 'late-night'],
    vibeTags: ['Palm West Beach', 'scene', 'group-dinner'],
    priceLevel: 3,
    sourceConfidence: 'curated',
    rating: 4.4,
    googleQuery: 'Surf Club Dubai Palm West Beach',
  }),
  definePlace({
    id: 'kyma-beach',
    slug: 'kyma-beach',
    ...
    subcategory: 'destination-dinner',
    area: 'Palm West Beach',
    description: 'A sharper Palm West Beach dinner play with proper atmosphere and enough crowd value to feel like a real night move.',
    tags: ['palm', 'destination', 'design-forward'],
    vibeTags: ['Palm West Beach', 'stylish', 'sunset-dinner'],
    priceLevel: 4,
    sourceConfidence: 'curated',
    rating: 4.5,
    googleQuery: 'KYMA Beach Dubai Palm West Beach',
  }),
  definePlace({
    id: 'lucky-fish',
    slug: 'lucky-fish',
    ...
    subcategory: 'smart-casual',
    area: 'Palm West Beach',
    description: 'A lighter Palm West Beach seafood option that still keeps the setting and social value high for a group stop.',
    tags: ['palm', 'casual', 'design-forward'],
    vibeTags: ['Palm West Beach', 'sea-breeze', 'easy-group'],
    priceLevel: 3,
    sourceConfidence: 'curated',
    rating: 4.4,
    googleQuery: 'Lucky Fish Dubai Palm West Beach',
  }),
  definePlace({
    id: 'carbone-dubai',
    slug: 'carbone-dubai',
  ...
  definePlace({
    ...
    subcategory: 'design-cafe',
    area: 'Al Quoz',
    description: 'A very on-brief Al Quoz coffee stop with roastery energy, creative crowd appeal, and a polished all-day feel that fits the weekend deck.',
    tags: ['coffee', 'design', 'alserkal'],
    vibeTags: ['roastery', 'creative', 'current'],
    priceLevel: 2,
    sourceConfidence: 'confirmed',
    rating: 4.7,
    googleQuery: 'Julith Cafe Dubai',
    openingHoursSummary: 'Mon-Fri 7:00AM-8:00PM, Sat-Sun 9:00AM-8:00PM',
    featured: true,
  }),
  definePlace({
  ...
  definePlace({
    id: 'five-palm-pool',
    slug: 'five-palm-pool',
    name: 'FIVE Palm Jumeirah Beach',
    emoji: '🏝️',
    category: 'chill',
    subcategory: 'beach-lounge',
    area: 'FIVE Palm Jumeirah',
    description: 'The only keep-in deck beach/dayclub option because the group already has access here and it is basically the free home-base flex.',
    tags: ['pool', 'palm', 'beach-club'],
    vibeTags: ['free-access', 'home-base', 'Palm'],
    priceLevel: 4,
    sourceConfidence: 'curated',
    rating: 4.5,
