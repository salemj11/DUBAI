        ...
        <div className="fade-up" style={{ textAlign: "center", width: "100%", maxWidth: 340 }}>
          ...
          {count < MAX_PLAYERS ? (
            <>
              ...
              <input value={pinInput} onChange={(e) => { setPinInput(e.target.value.replace(/\D/g, "").slice(0, 3)); }} onKeyDown={(e) => e.key === "Enter" && handleJoin()} placeholder="3-digit PIN" inputMode="numeric" maxLength={3} style={{ width: "100%", padding: "16px 20px", borderRadius: 14, background: "var(--s)", border: "1px solid var(--bl)", color: "var(--t)", fontSize: 16, fontFamily: "'Outfit',sans-serif", outline: "none", textAlign: "center", letterSpacing: 4, marginBottom: 12 }} />
